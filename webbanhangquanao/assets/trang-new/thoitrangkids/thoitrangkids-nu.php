...
$sql = "SELECT * from sanphamkids where gioitinhkids = 'benu'";
...
<head>
    ...
    <title>THỜI TRANG KIDS (BÉ GÁI)</title>
        ...
        <section class="clean-block clean-catalog dark">
            <div class="container">
                <div class="block-heading" style="color: rgb(0,0,0);">
                    <h2 class="text-info" style="font-size: 30px;color: rgb(0,0,0) !important;"><strong>THỜI TRANG KIDS (BÉ GÁI)</strong>
                    </h2>
