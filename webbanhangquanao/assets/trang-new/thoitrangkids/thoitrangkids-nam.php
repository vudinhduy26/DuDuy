...
$sql = "SELECT * from sanphamkids where gioitinhkids = 'benam'";
...
<head>
    ...
    <title>THỜI TRANG KIDS (BÉ TRAI)</title>
                        ...
                        <div class="nav-item dropdown" id="2-columnas"
                            ...
                            <div class="dropdown-menu multi-column columns-2" role="menu"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <ul class="multi-column-dropdown">
                                            <a class="dropdown-item" role="presentation" href="thoitrangkids-nam.php"
                                                style="border-bottom-width: 1.5px;border-bottom-style: solid;">Bé
                                                Trai</a>
                                            </br>
                                            <li><a class="dropdown-item" role="presentation" href="thoitrangkids-nam.php">Áo</a></li>
                                            <li><a class="dropdown-item" role="presentation" href="thoitrangkids-nam.php">Quần</a></li>
                                            <li><a class="dropdown-item" href="thoitrangkids-nam.php">Bộ Đồ</a></li>
                                            <li><a class="dropdown-item" href="thoitrangkids-nam.php">Phụ Kiện</a></li>
                                            <li><a class="dropdown-item" href="thoitrangkids-nam.php">Giày Dép</a></li>
                                        </ul>
                                    </div>
                                    <div class="col">
                                        <ul class="multi-column-dropdown">
                                            <a class="dropdown-item" href="thoitrangkids-nu.php"
                                                style="border-bottom-width: 1.5px;border-bottom-style: solid;">Bé
                                                Gái</a>
                                            </br>
                                            <li><a class="dropdown-item" href="thoitrangkids-nu.php">Áo</a></li>
                                            <li><a class="dropdown-item" href="thoitrangkids-nu.php">Quần</a></li>
                                            <li><a class="dropdown-item" href="thoitrangkids-nu.php">Bộ Đồ</a></li>
                                            <li><a class="dropdown-item" href="thoitrangkids-nu.php">Chân Váy</a></li>
                                            <li><a class="dropdown-item" href="thoitrangkids-nu.php">Váy</a></li>
                                            <li><a class="dropdown-item" href="thoitrangkids-nu.php">Phụ Kiện</a></li>
                                            <li><a class="dropdown-item" href="thoitrangkids-nu.php">Giày, Dép</a></li>
                                        </ul>
                                    </div>
                                    <div class="col">
                                        <ul class="multi-column-dropdown">
        ...
        <section class="clean-block clean-catalog dark">
            <div class="container">
                <div class="block-heading" style="color: rgb(0,0,0);">
                    <h2 class="text-info" style="font-size: 30px;color: rgb(0,0,0) !important;"><strong>THỜI TRANG KIDS (BÉ NAM)</strong>
                    </h2>
                                ...
                                <div class="tabPanel" style="background-color: white;">
                                    ...
                                    foreach ($data as $sanphamkids) {
                                        ...
                                        <div class="frame show" style="width: 100%;height: 360px;">
                                            ...
                                            <a href="../muahang1.php?Id='.$sanphamkids['Idsanphamkid'].'"><p style="font-size : 12px">'.$sanphamkids['Tensanphamkids'].'</p></a> 
                                        </div>
                                    </div>';
                                    }
                                    ?>
