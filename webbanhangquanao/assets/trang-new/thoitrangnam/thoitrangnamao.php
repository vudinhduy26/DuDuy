...
$sql = "SELECT * from sanphamnam where loaisanphamnam = 'ao'";
        ...
        <section class="clean-block clean-catalog dark">
            <div class="container">
                <div class="block-heading" style="color: rgb(0,0,0);">
                    <h2 class="text-info" style="font-size: 30px;color: rgb(0,0,0) !important;"><strong>THỜI TRANG NAM (ÁO)</strong>
                    </h2>
                    <a href="">Áo somi</a>
                    <a href="" style="margin-left: 3px ;">Áo Vest</a>
                    <a href="" style="margin-left: 3px ;">Áo polo</a>
                </div>
                <div class="content">
                    <div class="row">
                        <style>
