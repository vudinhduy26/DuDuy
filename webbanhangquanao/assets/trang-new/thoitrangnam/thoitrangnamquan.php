...
$sql = "SELECT * from sanphamnam where loaisanphamnam = 'quan'";
...
<head>
    ...
    <title>THỜI TRANG NAM (QUẦN)</title>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <ul class="multi-column-dropdown">
                                            <a class="dropdown-item" role="presentation" href="../thoitrangnam.php"
                                                style="border-bottom-width: 1.5px;border-bottom-style: solid;">Áo</a>
                                            </br>
                                            <li><a class="dropdown-item" role="presentation" href="../thoitrangnam.php">Áo Sơ Mi</a></li>
                                            <li><a class="dropdown-item" role="presentation" href="../thoitrangnam.php">Áo Phông</a></li>
                                            <li><a class="dropdown-item" href="../thoitrangnam.php">Áo Vest</a></li>
                                            <li><a class="dropdown-item" href="../thoitrangnam.php">Áo Polo Kiện</a></li>
                                            <li><a class="dropdown-item" href="../thoitrangnam.php">Áo Len,Nỉ</a></li>
                                            <li><a class="dropdown-item" href="../thoitrangnam.php">Áo Hoodie</a></li>
                                            <li><a class="dropdown-item" href="../thoitrangnam.php">Áo Khoác</a></li>
                                        </ul>
                                    </div>
                                    <div class="col">
                                        <ul class="multi-column-dropdown">
                                            ...
                                            <li><a class="dropdown-item" href="../thoitrangnam.php">Quần Âu</a></li>
                                            <li><a class="dropdown-item" href="../thoitrangnam.php">Quần Jeans</a></li>
                                            <li><a class="dropdown-item" href="../thoitrangnam.php">Quần Kaki</a></li>
                                            <li><a class="dropdown-item" href="../thoitrangnam.php">Quần Short</a></li>
                                            <li><a class="dropdown-item" href="../thoitrangnam.php">Quần Jogger</a></li>
                                            <li><a class="dropdown-item" href="../thoitrangnam.php">Quần Nỉ</a></li>
                                        </ul>
                                    </div>
                                    <div class="col">
                                        <ul class="multi-column-dropdown">
        ...
        <section class="clean-block clean-catalog dark">
            <div class="container">
                <div class="block-heading" style="color: rgb(0,0,0);">
                    <h2 class="text-info" style="font-size: 30px;color: rgb(0,0,0) !important;"><strong>THỜI TRANG NAM (QUẦN)</strong>
                    </h2>
                    <a href="">Quần âu</a>
                    <a href="" style="margin-left: 3px ;">Quần Jeans</a>
                    <a href="" style="margin-left: 3px ;">Quần kaki</a>
                </div>
                <div class="content">
                    <div class="row">
                        <style>
